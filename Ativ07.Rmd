...
teste = read_csv("C:/Users/lucas/OneDrive/Área de Trabalho/ME906/TRABALHO FINAL/teste.csv")
treino = read_csv("C:/Users/lucas/OneDrive/Área de Trabalho/ME906/TRABALHO FINAL/traino.csv")
```
...
```{r fig1, fig.align='center', fig.cap="Histogramas das variáveis numéricas", fig.height=6, fig.width=8,fig.pos="H", warning=FALSE}
colunas = colnames(numericas)[1:9]
par(mfrow=c(3,3))
for (v in colunas){hist(numericas[,v][[1]], main = v, xlab = "", ylab = "Frequência")}
```

```{r fig2, fig.align='center', fig.cap="Boxplots das variáveis numéricas", fig.height=6, fig.width=8,fig.pos="H", warning=FALSE}
colunas = colnames(numericas)[1:9]
par(mfrow=c(3,3))
...
```{r fig3, fig.align='center', fig.cap="Gráfico de disperção das variáveis numéricas e resposta", fig.height=8, fig.width=14,fig.pos="H", warning=FALSE, message=FALSE}
...
```{r fig4, fig.align='center', fig.cap="Boxplots das variáveis numéricas", fig.height=4, fig.width=12,fig.pos="H", warning=FALSE}
treino_validacao %>%
  ggplot()+
