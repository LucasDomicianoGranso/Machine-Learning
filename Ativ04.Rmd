...
Portanto, nossa matriz X será composta por todas as variáveis do conjundo de dados descritas anteriormente, exceto pelas variáveis "TotRms_AbvGrd" e "Sale_Price" (a primeira porque foi removida e segunda porque é nossa variável resposta, sendo ela, portanto, o nosso vetor y).
